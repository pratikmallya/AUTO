...
#define ICNI_TYPE(X) int X(const iap_type *iap, const rap_type *rap, integer ndim, doublereal *par, const integer *icp, integer nint, doublereal *u, const doublereal *uold, const doublereal *udot, const doublereal *upold, doublereal *f, integer ijac, doublereal *dint)
...
int init(iap_type *iap, rap_type *rap, doublereal *par, integer **icu_pointer, void **thl_pointer, doublereal **thu_pointer, integer **iuz_pointer, doublereal **vuz_pointer, logical *eof,integer nalc);
...
int autobv(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, integer *icu, FUNI_TYPE((*funi)), BCNI_TYPE((*bcni)), ICNI_TYPE((*icni)), STPNT_TYPE_BVP((*stpnt)), PVLI_TYPE_BVP((*pvli)), doublereal *thl, doublereal *thu, integer *iuz, doublereal *vuz);
int init1(iap_type *iap, rap_type *rap, integer **icp_pointer, void **thl_pointer, integer *icu, doublereal *par);
int cnrlae(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, integer *icu, FUNI_TYPE((*funi)), STPNT_TYPE_AE((*stpnt)), PVLI_TYPE_AE((*pvli)), doublereal *thl, doublereal *thu, integer *iuz, doublereal *vuz);
...
FNCS_TYPE_AE(fnhbae);
FNCS_TYPE_AE(fnuzae);
int stbif(iap_type *iap, integer *icp, integer *m1aaloc, doublereal **aa, doublereal **stud, doublereal **stu, doublereal *stla, doublereal *stld, doublereal *rlcur, doublereal *rldot, doublereal *u, doublereal *du, doublereal *udot, doublereal *dfdu, doublereal *dfdp, doublereal *thl, doublereal *thu);
int swpnt(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, doublereal *rds, doublereal **stud, doublereal **stu, doublereal *stla, doublereal *stld, doublereal *rlcur, doublereal *rldot, doublereal *u, doublereal *udot);
...
int sthd(const iap_type *iap, const rap_type *rap, const integer *icp, const integer *icu);
int headng(const iap_type *iap, const integer *icp, integer iunit, integer n1, integer n2);
int stplae(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, integer *icu, doublereal *rlcur, doublereal *u);
int wrline(iap_type *iap, doublereal *par, integer *icu, integer ibr, integer ntot, integer lab, doublereal vaxis, doublereal *u);
...
int adapt(iap_type *iap, integer nold, integer ncold, integer nnew, integer ncnew, doublereal *tm, doublereal *dtm, integer ndxloc, doublereal **ups, doublereal **vps);
int interp(integer ndim, integer n, integer nc, doublereal *tm, doublereal **ups, integer n1, integer nc1, doublereal *tm1, doublereal **ups1, doublereal *tm2, integer *itm1);
int newmsh(integer ndim, doublereal **ups, integer nold, integer ncold, doublereal *tmold, doublereal *dtmold, integer nnew, doublereal *tmnew, integer iper);
int ordr(integer n, doublereal *tm, integer n1, doublereal *tm1, integer *itm1);
int intwts(integer n, doublereal z, doublereal *x, doublereal *wts);
int eqdf(integer ntst, integer ndim, integer ncol, doublereal *dtm, doublereal **ups, doublereal *eqf, integer iper);
int eig(iap_type *iap, integer *ndim, integer *m1a, doublereal *a, doublecomplex *ev, integer *ier);
/* "k" is the dimension of the null space, 
   "useDefaultRHS" defines whether or not we use the "input" vector as the right hand side 
      (if useDefaultRHS == 0 we use "input", otherwise we use 1,1,1,1,1...
   "RHSVector" is the vector we use for the right hand side if useDefaultRHS == 0
*/
int nlvc(integer n, integer m, integer k, integer useDefaultRHS, doublereal *RHSVector,doublereal **a, doublereal *u);
...
void readlbbv(iap_type *iap, doublereal *par, integer *icprs, integer *ntsr,
	      integer *ncolrs, integer *pndimrd, doublereal *rldotrs, doublereal **ups,
	      doublereal **udotps, doublereal *tm, integer *itprs);
int skip3(integer *nskip, logical *eof3);
doublereal rinpr(iap_type *iap, integer ndim1, doublereal **ups, doublereal **vps, doublereal *dtm, doublereal *thu);
...
int cnrlbv(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, integer *icu, FUNI_TYPE((*funi)), BCNI_TYPE((*bcni)), ICNI_TYPE((*icni)), STPNT_TYPE_BVP((*stpnt)), PVLI_TYPE_BVP((*pvli)), doublereal *thl, doublereal *thu, integer *iuz, doublereal *vuz);
...
void extrbv(iap_type *iap, rap_type *rap, FUNI_TYPE((*funi)), doublereal rds, doublereal *rlcur, doublereal *rlold, doublereal *rldot, doublereal **ups, doublereal **uoldps, doublereal **udotps);
...
int setrtn(integer ndm, integer ntst, doublereal **ups, doublereal *par);
...
int stplbv(iap_type *iap, rap_type *rap, doublereal *par, integer *icp, integer *icu, doublereal *rldot, integer ndxloc, doublereal **ups, doublereal **udotps, doublereal *tm, doublereal *dtm, doublereal *thl, doublereal *thu);
...
int setrhs(integer ndim, integer ips, integer na, integer ntst, integer *np, integer ncol, integer nbc, integer nint,
#ifdef MANIFOLD
	   integer nalc,
#endif
	   integer ncb, integer nrc, integer nra, integer *iam, integer *kwt, logical *ipar, FUNI_TYPE((*funi)), BCNI_TYPE((*bcni)), ICNI_TYPE((*icni)), integer ndxloc, iap_type *iap, rap_type *rap, doublereal *par, integer *icp, doublereal *rds, doublereal **fa, doublereal *fc, doublereal *rlcur, doublereal *rlold, doublereal *rldot, doublereal **ups, doublereal **uoldps, doublereal **udotps, doublereal **upoldp, doublereal **dups, doublereal *dtm, doublereal *thl, doublereal *thu);
int brbd(doublereal ***a, doublereal ***b, doublereal ***c, doublereal **d, doublereal **fa, doublereal *fc, doublereal **p0, doublereal **p1, integer ifst, integer idb, integer nllv, doublereal *det, integer nov, integer na, integer nbc, integer nra, integer nca, integer ncb, integer nrc, integer iam, integer kwt, logical par, doublereal ***a1, doublereal ***a2, doublereal ***bb, doublereal ***cc, doublereal ***ccbc, doublereal **faa, doublereal ***ca1, doublereal ***s1, doublereal ***s2, integer *icf11, integer *ipr, integer *icf1, integer *icf2, integer *irf, integer *icf
#ifdef MANIFOLD
	 ,integer useDefaultRHS,double *RHSVector
#endif
	 );
int setzero(doublereal **fa, doublereal *fc, integer na, integer nra, integer nrc);
int conrhs(integer nov, integer na, integer nra, integer nca, doublereal ***a, integer nrc, doublereal ***c, doublereal **fa, doublereal *fc, integer *irf, integer *icf);
...
int redrhs(integer iam, integer kwt, logical par, doublereal ***a1, doublereal ***a2, doublereal ***cc, doublereal **faa, doublereal *fc, integer na, integer nov, integer nrc, doublereal ***ca1, integer *icf1, integer *icf2, integer *icf11, integer *ipr);
int dimrge(integer iam, integer kwt, logical par, doublereal ***cc, doublereal ***ccbc, doublereal **d, doublereal *fc, integer na, integer nrc, integer nbc, integer nov, integer ncb, integer idb, integer nllv, doublereal *fcc, doublereal **p0, doublereal **p1, doublereal *det, doublereal ***s, doublereal ***a2, doublereal **faa, doublereal ***bb
#ifdef MANIFOLD
	   ,integer useDefaultRHS,doublereal *RHSVector
#endif
	   );
int bcksub(integer iam, integer kwt, logical par, doublereal ***s1, doublereal ***s2, doublereal ***a2, doublereal ***bb, doublereal **faa, doublereal *fc, doublereal *fcc, doublereal *sol1, doublereal *sol2, integer na, integer nov, integer ncb, integer *icf2);
int infpar(doublereal ***a, doublereal ***b, doublereal **fa, doublereal *sol1, doublereal *sol2, doublereal *fc, integer na, integer nov, integer nra, integer nca, integer ncb, integer *irf, integer *icf);
int rd0(integer *iam, integer *kwt, doublereal *d, integer nrc);
int print1(integer na, integer nra, integer nca, integer ncb, integer nrc, integer nbc, doublereal ***a, doublereal ***b, doublereal ***c, doublereal ***cbc, doublereal **d, doublereal **fa, doublereal *fc);
integer mynode(void);
...
/* autlib5.c */
FUNI_TYPE(fnho);
int ffho(const iap_type *iap, const rap_type *rap, integer ndim, doublereal *u, const doublereal *uold, const integer *icp, doublereal *par, doublereal *f, integer ndm, doublereal *dfdu);
BCNI_TYPE(bcho);
int fbho(const iap_type *iap, const rap_type *rap, integer ndim, doublereal *par, const integer *icp, integer nbc, integer nbc0, const doublereal *u0, const doublereal *u1, doublereal *fb);
ICNI_TYPE(icho);
int fiho(const iap_type *iap, const rap_type *rap, integer ndim, doublereal *par, const integer *icp, integer nint, integer nnt0, doublereal *u, const doublereal *uold, const doublereal *udot, const doublereal *upold, doublereal *fi);
int inho(iap_type *iap, integer **icp_pointer, doublereal *par);
...
int eigho(const iap_type *iap, const rap_type *rap, integer itrans, doublereal *rr, doublereal *ri, doublereal **vret, doublereal *xequib, const integer *icp, doublereal *par, integer ndm);
int prjctn(const iap_type *iap, const rap_type *rap, doublereal **bound, doublereal *xequib, const integer *icp, doublereal *par, integer imfd, integer is, integer itrans, integer ndm);
/* eispack.c */
...
typedef int user_pvls_t(integer ndim, const void *u, doublereal *par);
...
int conpar(integer nov, integer na, integer nra, integer nca, doublereal ***a, integer ncb, doublereal ***b, integer nrc, doublereal ***c, doublereal **d, integer *irf, integer *icf);


/* reduce.c */
int reduce(integer iam, integer kwt, logical par, doublereal ***a1, doublereal ***a2, doublereal ***bb, doublereal ***cc, doublereal **dd, integer na, integer nov, integer ncb, integer nrc, doublereal ***s1, doublereal ***s2, doublereal ***ca1, integer *icf1, integer *icf2, integer *icf11, integer *ipr);

/*setubv.c */
#include "auto_types.h"
int setubv_make_aa_bb_cc_dd(integer ndim, integer na, integer ncol, integer nint, 
#ifdef MANIFOLD
       integer nalc,
#endif
...
int setubv(integer ndim, integer ips, integer na, integer ncol, integer nint, 
#ifdef MANIFOLD
       integer nalc,
#endif
...
void setubv_make_boundary(integer ndim, integer na, integer nbc,
       ...
       integer *icp, doublereal ***cc, doublereal **dd, doublereal *fc,
